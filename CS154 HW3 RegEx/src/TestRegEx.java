public class TestRegEx {
    ...
    public static void test1() {
        ...
        System.out.println(zero.matches("0")); // Testing literal
        System.out.println(r1.matches("000"));
        System.out.println("......");
        
        System.out.println(r3.matches("000111")); // Testing Concat
        ...
        System.out.println(r3.matches("10101010"));
        System.out.println("......");
        
        System.out.println(r4.matches("000")); // Testing Choice
        System.out.println(r4.matches("1111111111"));
        System.out.println(r4.matches("0001"));
        System.out.println("......");
        
        System.out.println(r5.matches("1")); // Testing Option
